...
load(file.path("demo", "densite_all_param.RData"))
...
compatibility_repo_taxonomy <- read.csv(file.path("demo", "compatibility_repo_taxonomy_v3.csv"),
               sep = ";",
               header = TRUE)
...
result_GENUS_IG2 <- prcc_vcc_genus(n = 50, df_wide_IG2 = df_wide_IG2, densite_all_param = densite_all_param, genus_name = "GENUS")
